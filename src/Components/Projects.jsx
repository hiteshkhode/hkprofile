...
function projects() {
    ...
    return (
        <div className="projects">
            <div className="projectsWrapper flex flex-col items-center" id="projects">
                ...
                <Project title = {projectsJSON[3].title} description = {projectsJSON[3].description} links = {projectsJSON[3].link} project="polling-site" />
                <Project title = {projectsJSON[4].title} description = {projectsJSON[4].description} links = {projectsJSON[4].link} project="versatile" />
            </div>
        </div>
    )
}
